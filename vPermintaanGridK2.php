...
$query = "SELECT * FROM fungsi_keanggotaan_gridk2 WHERE jenis='Permintaan' ORDER BY batas_atas ASC;";
...
<body class="theme-red">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Fungsi Keanggotaan Fuzzy Grid Partition K2 - Variabel Permintaan
                            </h2>
                        </div>
                        <div class="body">
                            <?php if (!$Exists): ?>
                                <a class="btn btn-primary" href="inputPermintaanGridK2.php" role="button">Tambah Fungsi Keanggotaan</a>
                            <?php else: ?>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="editVPermintaanGridK2.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a>
                                                    <a href="hapusVPermintaanGridK2.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endwhile; ?>
                                    </tbody>
    ...
    <script>
        fetch('getVPermintaanGridK2.php')
