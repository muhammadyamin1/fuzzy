...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $queryMenurun = "INSERT INTO fungsi_keanggotaan_gridk3 (jenis, nama_fungsi, tipe, batas_bawah, batas_tengah, batas_atas) 
    ...
    foreach ($namaFungsiSegitiga as $index => $namaFungsi) {
        $querySegitiga = "INSERT INTO fungsi_keanggotaan_gridk3 (jenis, nama_fungsi, tipe, batas_bawah, batas_tengah, batas_atas) 
    ...
    // Simpan kurva menaik
    $queryMenaik = "INSERT INTO fungsi_keanggotaan_gridk3 (jenis, nama_fungsi, tipe, batas_bawah, batas_tengah, batas_atas) 
