...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_check_id = "SELECT id FROM rule_tsukamoto WHERE id = '$rule_id_prefiks'";
    ...
    if ($result_check_id && $result_check_id->num_rows > 0) {
        ...
        $sql_check_combination = "SELECT id FROM rule_tsukamoto WHERE permintaan = '$permintaan' AND stok = '$stok' AND produksi = '$produksi'";
        ...
        if ($result_check_combination && $result_check_combination->num_rows > 0) {
            ...
            $sql = "INSERT INTO rule_tsukamoto (id, permintaan, stok, produksi) VALUES ('$rule_id_prefiks', '$permintaan', '$stok', '$produksi')";
