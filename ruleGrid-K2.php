            ...
            <div class="block-header">
                <div class="row clearfix">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Rule Fuzzy Grid Partition (K=2)</li>
                    </ol>
                </div>
            </div>
            <?php
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Daftar Rule Fuzzy Grid Partition (K=2)
                            </h2>
                        </div>
                        <div class="body">
                            ...
                            <a href="inputRuleGridK2.php" class="btn btn-info" role="button">Tambah Rule Horizontal</a>
                            ...
                            <div class="modal fade" id="ruleModal" tabindex="-1" role="dialog" aria-labelledby="ruleModalLabel">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="simpanRuleGridK2.php" method="POST">
                                            <div class="modal-body">
                                                ...
                                                <select name="permintaan" id="permintaan" class="form-control show-tick">
                                                    ...
                                                    $queryPermintaan = "SELECT nama_fungsi FROM fungsi_keanggotaan_gridk2 WHERE jenis = 'Permintaan'";
                                                ...
                                                <select name="stok" id="stok" class="form-control">
                                                    ...
                                                    $queryStok = "SELECT nama_fungsi FROM fungsi_keanggotaan_gridk2 WHERE jenis = 'Stok'";
                                                ...
                                                <select name="produksi" id="produksi" class="form-control">
                                                    ...
                                                    $queryProduksi = "SELECT nama_fungsi FROM fungsi_keanggotaan_gridk2 WHERE jenis = 'Produksi'";
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        FROM rule_gridk2 r 
                                        INNER JOIN fungsi_keanggotaan_gridk2 f1 ON r.permintaan = f1.nama_fungsi AND f1.jenis = 'Permintaan' 
                                        INNER JOIN fungsi_keanggotaan_gridk2 f2 ON r.stok = f2.nama_fungsi AND f2.jenis = 'Stok' 
                                        INNER JOIN fungsi_keanggotaan_gridk2 f3 ON r.produksi = f3.nama_fungsi AND f3.jenis = 'Produksi' 
                                            ...
                                            while ($row = $resultRule->fetch_assoc()) {
                                                echo "<tr>
                                                    ...
                                                    <td class='action-center'>
                                                        <a href='hapusRuleGridK2.php?id={$row['id']}' class='btn btn-danger' onclick=\"return confirm('Yakin ingin menghapus data ini?')\">Hapus</a>
                                                    </td>
                                                </tr>";
                                            }
                                        } else {
