...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    for ($i = 0; $i < count($rule_ids); $i++) {
        ...
        $sql_check_key = "SELECT * FROM rule_gridk3 WHERE id = '$rule_id'";
        ...
        if ($result_check_key->num_rows > 0) {
            ...
            $sql_check_combination = "SELECT * FROM rule_gridk3 WHERE permintaan = '$permintaan' AND stok = '$stok' AND produksi = '$produksi'";
            ...
            if ($result_check_combination->num_rows > 0) {
                ...
                $sql = "INSERT INTO rule_gridk3 (id, permintaan, stok, produksi) VALUES ('$rule_id', '$permintaan', '$stok', '$produksi')";
