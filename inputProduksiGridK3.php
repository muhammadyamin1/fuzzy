            ...
            <div class="row clearfix">
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Tambah Fungsi Keanggotaan Fuzzy Grid Partition K3 - Variabel Produksi
                            </h2>
                        </div>
                        <div class="body">
                            <form action="simpanVProduksiGridK3.php" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="text-right">
                                        <a class="btn bg-grey waves-effect" role="button" href="vProduksiGridK3.php">Kembali</a>
