            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Tambah Rule Fuzzy Tsukamoto
                            </h2>
                        </div>
                        <div class="body">
                            <form action="simpanRuleTsukamotoHorizontal.php" method="POST" id="ruleForm">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <a class="btn bg-grey waves-effect" role="button" href="ruleTsukamoto.php">Kembali</a>
