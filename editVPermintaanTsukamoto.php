...
$id = $_GET['id'];
$query = "SELECT * FROM fungsi_keanggotaan_tsukamoto WHERE id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update data
    $updateQuery = "UPDATE fungsi_keanggotaan_tsukamoto SET 
...
<body>
    <div class="container">
        ...
        <form action="" method="POST">
            ...
            <a href="vPermintaanTsukamoto.php" class="btn btn-secondary">Batal</a>
        </form>
    </div>
</body>
