...
$query = "SELECT * FROM fungsi_keanggotaan_tsukamoto WHERE jenis='Permintaan' ORDER BY batas_atas ASC;";
...
<body class="theme-red">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Fungsi Keanggotaan Fuzzy Tsukamoto - Variabel Permintaan
                            </h2>
                        </div>
                        <div class="body">
                            <?php if (!$Exists): ?>
                                <a class="btn btn-primary" href="inputPermintaanTsukamoto.php" role="button">Tambah Fungsi Keanggotaan</a>
                            <?php else: ?>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="editVPermintaanTsukamoto.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a>
                                                    <a href="hapusVPermintaanTsukamoto.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endwhile; ?>
                                    </tbody>
    ...
    <script>
        fetch('getVPermintaanTsukamoto.php')
