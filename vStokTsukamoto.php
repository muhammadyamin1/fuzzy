...
$query = "SELECT * FROM fungsi_keanggotaan_tsukamoto WHERE jenis='Stok' ORDER BY batas_atas ASC;";
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Fungsi Keanggotaan Fuzzy Tsukamoto - Variabel Stok
                            </h2>
                        </div>
                        <div class="body">
                            <?php if (!$stokExists): ?>
                                <a class="btn btn-primary" href="inputStokTsukamoto.php" role="button">Tambah Fungsi Keanggotaan</a>
                            <?php else: ?>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="editVStokTsukamoto.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a>
                                                    <a href="hapusVStokTsukamoto.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endwhile; ?>
                                    </tbody>
