                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        FROM rule_tsukamoto r 
                                        INNER JOIN fungsi_keanggotaan_tsukamoto f1 ON r.permintaan = f1.nama_fungsi AND f1.jenis = 'Permintaan' 
                                        INNER JOIN fungsi_keanggotaan_tsukamoto f2 ON r.stok = f2.nama_fungsi AND f2.jenis = 'Stok' 
                                        INNER JOIN fungsi_keanggotaan_tsukamoto f3 ON r.produksi = f3.nama_fungsi AND f3.jenis = 'Produksi' 
                                        ...
                                        if ($resultRule->num_rows > 0) {
                                            while ($row = $resultRule->fetch_assoc()) {
                                                echo "<tr>
                                                    ...
                                                    <td class='text-center'>\\({$row['permintaan_latex']}\\)</td>
                                                    <td class='text-center'>\\({$row['stok_latex']}\\)</td>
                                                    <td class='text-center'>\\({$row['produksi_latex']}\\)</td>
