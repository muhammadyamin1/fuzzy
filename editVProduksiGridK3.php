...
$id = $_GET['id'];
$query = "SELECT * FROM fungsi_keanggotaan_gridk3 WHERE id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update data
    $updateQuery = "UPDATE fungsi_keanggotaan_gridk3 SET 
...
<body>
    <div class="container">
        ...
        <form action="" method="POST">
            ...
            <a href="vProduksiGridK3.php" class="btn btn-secondary">Batal</a>
        </form>
    </div>
</body>
