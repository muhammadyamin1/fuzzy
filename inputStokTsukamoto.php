            ...
            <div class="row clearfix">
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Tambah Fungsi Keanggotaan Fuzzy Tsukamoto - Variabel Stok
                            </h2>
                        </div>
                        <div class="body">
                            <form action="simpanVStokTsukamoto.php" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="text-right">
                                        <a class="btn bg-grey waves-effect" role="button" href="vStokTsukamoto.php">Kembali</a>
